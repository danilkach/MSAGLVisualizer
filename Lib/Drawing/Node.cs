...
/// </summary>
        ...
        public bool isAdjacentTo(Node n)
        {
            return this.Edges.Any(e => (e.SourceNode == this && e.TargetNode == n) ||
                (e.SourceNode == n && e.TargetNode == this));
        }
        public IEnumerable<Node> AdjacentNodes
        {
            get
            {
                ...
                foreach (Edge e in this.Edges)
                    ...
                    {
                        Node currentNode = e.SourceNode == this ? e.TargetNode : e.SourceNode;
