...
/// </summary>
        ...
        public bool isAdjasentTo(Edge e)
        {
            return (e.TargetNode == this.targetNode) || (e.SourceNode == this.SourceNode) ||
                (e.SourceNode == this.TargetNode) || (e.TargetNode == this.SourceNode);
        }
/// <summary>
