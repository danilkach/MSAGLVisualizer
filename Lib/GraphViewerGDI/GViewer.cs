...
namespace Microsoft.Msagl.GraphViewerGdi {
    ...
    public sealed partial class GViewer : UserControl
    {
        ...
        const string PanButtonDisabledToolTipText = "Перетаскивание";
        ...
        void InitializeComponent()
        {
            ...
            this.homeZoomButton.Size = new System.Drawing.Size(23, 22);
            this.homeZoomButton.ToolTipText = "Отцентровать";
            // 
            // zoomin
            // 
            ...
            this.zoomin.ToolTipText = "Приблизить";
            // 
            // zoomout
            // 
            ...
            this.zoomout.ToolTipText = "Отдалить";
            // 
            // windowZoomButton
            // 
            ...
            this.windowZoomButton.Size = new System.Drawing.Size(23, 22);
            this.windowZoomButton.ToolTipText = "Zoom in to the rectangle";
            this.windowZoomButton.CheckedChanged += new System.EventHandler(this.ToolBarButtonCheckChanged);
            // 
            // panButton
            // 
            ...
            this.panButton.ToolTipText = "Перетаскивание";
            this.panButton.CheckedChanged += new System.EventHandler(this.ToolBarButtonCheckChanged);
            // 
            // backwardButton
            // 
            ...
            this.saveButton.ToolTipText = "Сохранить граф или его изображение";
            // 
            // undoButton
            // 
            ...
            this.openButton.ToolTipText = "Загрузить граф из \".msagl\" файла";
            // 
            // print
            // 
            ...
            this.print.ToolTipText = "Распечатать граф";
            // 
            ...
            this.edgeInsertButton.Size = new System.Drawing.Size(23, 22);
            this.edgeInsertButton.ToolTipText = "Edge insertion";
            this.edgeInsertButton.CheckedChanged += new System.EventHandler(this.ToolBarButtonCheckChanged);
            // 
            // GViewer
            // 
        ...
        ///// <param name="registerForUndo"></param>
        ///// <returns></returns>
        public Drawing.Edge AddEdge(Drawing.Node source, Drawing.Node target, bool registerForUndo, ArrowStyle style = ArrowStyle.None)
        {
            ...
            /*if (weight != null)
            {
                drawingEdge.UserData = drawingEdge.LabelText = weight.ToString();
                drawingEdge.Attr.Weight = int.Parse(weight.ToString());
            }*/
            drawingEdge.Attr.ArrowheadAtTarget = style;
            ...
            geometryEdge.EdgeGeometry.TargetArrowhead = new Arrowhead() { Length = drawingEdge.Attr.ArrowheadLength + (style == ArrowStyle.None ? -10 : 0) };
        ...
        public IViewerEdge CreateEdgeWithGivenGeometry(DrawingEdge drawingEdge)
        {
            if (drawingEdge.Label == null)
                drawingEdge.Label = new Label();
            drawingEdge.Label.Owner = drawingEdge;
            Edge geometryEdge = drawingEdge.GeometryEdge;
            //Debug.Assert(geometryEdge != null);
            geometryEdge.GeometryParent = Graph.GeometryGraph;
            //eometryEdge.Label = new Core.Layout.Label(geometryEdge);

            //drawingEdge.Label.Owner = drawingEdge;
            var dEdge = new DEdge(DGraph.FindDNode(drawingEdge.SourceNode.Id), DGraph.FindDNode(drawingEdge.TargetNode.Id),
                                  drawingEdge, ConnectionToGraph.Disconnected, this);
            dEdge.Label = new DLabel(dEdge, new Label(), this);
            //drawingEdge.GeometryEdge = geometryEdge;
            //Console.WriteLine(drawingEdge.Label.Center);
            //dEdge.Label.DrawingLabel.UserData = dEdge.Label.DrawingLabel.Text = drawingEdge.LabelText;
            return dEdge;
        }
    ...
    void TestSomeGraphs() {
      if (fileName.EndsWith("lovett.dot")) {
        ...
        ToolStripMenuItem[] CreateSaveMenuItems()
        {
            ...
            {
                menuItems.Add(menuItem = new ToolStripMenuItem("Сохранить граф"));
                menuItem.Click += SaveGraphClick;
            }
            if (SaveAsImageEnabled)
            {
                menuItems.Add(menuItem = new ToolStripMenuItem("Сохранить в .jpg"));
                menuItem.Click += SaveImageClick;
            }
            if (SaveInVectorFormatEnabled)
            {
                menuItems.Add(menuItem = new ToolStripMenuItem("Сохранить в .svg"));
